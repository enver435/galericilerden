		...
		<div class="container">
			...
			<div class="step-content">
				...
				{if $return.siteConfig.iyzicoPayment === false}
					<button type="submit" name="complete" onclick="{literal}$('form[name=store-year-update]').submit();{/literal}" class="btn btn-primary pull-right" style="padding: 10px 20px;">Mağazanızı Güncelleyin</button>
				{/if}
				{if $return.siteConfig.iyzicoPayment === true}
