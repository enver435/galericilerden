				...
				<div class="ad-list">
					<div class="col-lg-10 col-md-10" style="padding-left: 0;width: 80%;">
						<div class="block category-step">
							<p style="display: inline-block;"><b>"{userInfo($smarty.get.userId, 'name')|capitalize} {userInfo($smarty.get.userId, 'surname')|capitalize}"</b> kullanıcısına ait <strong style="color: #ff263a;">{$return.userAdsCount|number_format:0:".":","} ilan</strong> bulundu</p>
						...
						<div class="ads-container">
								...
								<div class="list-desktop hidden-sm hidden-xs">
									{if $return.userAds}
										<table class="table">
											...
											<tbody>
												{foreach $return.userAds as $ads}
													<tr onclick="location.href='{siteUrl('view')}/{$ads.seflink}-{$ads.id}'">
														<td width="116">
							...
							{if $return.pagination.desktopPagination != ''}
								...
								<div class="mobilePagination hidden-lg hidden-md">{$return.pagination.mobilePagination}</div>
							{/if}
						</div>
					</div>	
				</div>
