		...
		<div class="container">
			...
			{else}
				<ul class="breadcrumb">
				    <li><a href="{SITE_URL}">Anasayfa</a></li>
				    <li class="active">
				    	{if getUrl(1) == 'individual'}
				    		Bireysel Üye Ol
				    	{elseif getUrl(1) == 'corporate'}
				    		Kurumsal Üye Ol
				    	{/if}
				    </li>
				</ul>
				...
				{if !getUrl(1)}
					<div class="col-md-6">
						<div class="block">
							...
							<div class="block-content">
								<div class="col-md-12">
									<a href="{siteUrl('register/individual')}">
					...
					<div class="col-md-6">
						<div class="block">
							...
							<div class="block-content">
								<div class="col-md-12">
									<a href="{siteUrl('register/corporate')}">
					...
					<div class="col-md-6">
						<div class="block">
							...
							<div class="block-content">
								<div class="col-md-12">
									{if isset($smarty.post.reg) OR isset($smarty.post.activate)}
									...
									<form action="" method="POST">
										{if !$smarty.session.phoneActivate}
												...
												<div class="form-group">
													...
													<select name="city" class="form-control">
														...
														{foreach $return.cities as $cities}
															<option value="{$cities.CityID}" data-plate="{$cities.PlateNo}">{$cities.CityName}</option>
														{/foreach}
													</select>
												</div>
												<div class="form-group">
										...
										{else}
											<div class="form-group">
												...
												<input type="text" value="{$smarty.session.phoneNumber}" disabled="disabled" class="form-control">
											</div>
											<div class="form-group">
