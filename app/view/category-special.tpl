	...
	<div class="page-content">
		<div class="container">
			<div class="row">
				...
				{assign var=typeAracSahibi value=$Ads->checkTypeAds(null, $smarty.get.catType, 0)}
				{assign var=typeGaleriden value=$Ads->checkTypeAds(null, $smarty.get.catType, 1)}
				{assign var=typeYetkiliBayiden value=$Ads->checkTypeAds(null, $smarty.get.catType, 2)}
				{assign var=typeUreticiden value=$Ads->checkTypeAds(null, $smarty.get.catType, 3)}
				...
				<div class="ad-list">
					<div class="col-lg-10 col-md-10" style="padding-left: 0;width: 80%;">
						<div class="block category-step">
							<p style="display: inline-block;"><b>"{if $smarty.get.catType == 'ilk-sahibinden'}İlk Sahibiden{elseif $smarty.get.catType == 'yeni-gibi'}Yeni Gibi{elseif $smarty.get.catType == 'ekspertizli'}Ekspertizli{elseif $smarty.get.catType == 'acil'}Acil{elseif $smarty.get.catType == 'fiyati-dusenler'}Fiyatı Düşenler{/if}"</b> aramanızda <strong style="color: #ff263a;">{$return.categoryAdsCount|number_format:0:".":","} ilan</strong> bulundu</p>
							{if $smarty.session.login}
								...
								<p class="pull-right save-search" onclick="{literal}addFavoriteSearch({/literal}{if $smarty.get.catType == 'ilk-sahibinden'}1{elseif $smarty.get.catType == 'yeni-gibi'}2{elseif $smarty.get.catType == 'ekspertizli'}3{elseif $smarty.get.catType == 'acil'}4{elseif $smarty.get.catType == 'fiyati-dusenler'}5{/if}, {if !$smarty.get.type}null{else}{$smarty.get.type}{/if}, {if !$smarty.get.orderby}0{else}{if $smarty.get.orderby == 'pricehigh'}1{elseif $smarty.get.orderby == 'pricelow'}2{elseif $smarty.get.orderby == 'datenew'}3{elseif $smarty.get.orderby == 'dateold'}4{elseif $smarty.get.orderby == 'kmlow'}5{elseif $smarty.get.orderby == 'kmhigh'}6{elseif $smarty.get.orderby == 'yearold'}7{elseif $smarty.get.orderby == 'yearnew'}8{/if}{/if}, true{literal});{/literal}"><i class="material-icons" style="vertical-align: middle;">search</i> Aramayı Kaydet</p>
							{else}
										...
										<ul class="doping-up">
											{foreach $return.categoryDopingUpAds as $ads}
												<li class="{if $ads.doping_differently == 1}doping-differently{/if}{if $ads.doping_acil == 1} doping-acil{/if}">
													...
													<div class="title">
														<a href="{siteUrl('view')}/{$ads.seflink}-{$ads.id}">{strShorten($ads.title, 40, '...')}</a>
													</div>
