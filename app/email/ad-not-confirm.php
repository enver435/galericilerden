...
.footer a, .footer a:hover {
	...
	<!-- MESSAGE SUBJECT -->
	<title>Galericilerden.com - İlanınız Onaylanamadı</title>
...
<table border="0" cellpadding="0" cellspacing="0" align="center"
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
			...
			font-family: sans-serif;" class="paragraph">
				<p><?php echo $id; ?> no'lu ilanınız onaylanamadı.</p>
				<p>Lütfen aşağıda belirttiğimiz uygunsuz görülen alanları <a target="_blank" href="<?php echo siteUrl('my-ads/ad-edit') . '/' . $id; ?>">İlanlarım</a> sayfasından düzeltiniz.</p>
				<span style="display:block;margin-top:10px;color:#e04b4e">
					<?php

						if($_POST['sebep'] == 1)
						{
							echo 'İlan başlığı veya ilan açıklaması kurallara uymadığı için ilanınız onaylanmamıştır';
						}
						elseif($_POST['sebep'] == 2)
						{
							echo 'İlan resimleri orjinal olmadığı için ilanınız onaylanmamıştır';
						}
						elseif($_POST['sebep'] == 3)
						{
							echo 'Reklam ve spam nedeniyle ilanınız onaylanmamıştır';
						}
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
			...
			href="<?php echo siteUrl('my-ads/ad-edit') . '/' . $id; ?>" target="_blank" style="text-decoration: underline;">
				<table border="0" cellpadding="0" cellspacing="0" align="center" style="max-width: 240px; min-width: 120px; border-collapse: collapse; border-spacing: 0; padding: 0;"><tr><td align="center" valign="middle" style="padding: 12px 24px; margin: 0; text-decoration: underline; border-collapse: collapse; border-spacing: 0; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; -khtml-border-radius: 4px;"
					bgcolor="#E9703E"><a target="_blank" style="text-decoration: underline;
					color: #FFFFFF; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 120%;"
					href="<?php echo siteUrl('my-ads/ad-edit') . '/' . $id; ?>">
						İlanı Düzenle
					</a>
			</td></tr></table></a>
		</td>
