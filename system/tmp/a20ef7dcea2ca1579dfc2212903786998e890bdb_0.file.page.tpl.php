<?php /* Smarty version 3.1.27, created on 2018-01-19 12:56:00
         compiled from "C:\xampp\htdocs\galericilerden\app\view\page.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:72075a61dcd07a4128_60550644%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a20ef7dcea2ca1579dfc2212903786998e890bdb' => 
    array (
      0 => 'C:\\xampp\\htdocs\\galericilerden\\app\\view\\page.tpl',
      1 => 1516362958,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '72075a61dcd07a4128_60550644',
  'variables' => 
  array (
    'return' => 0,
    'doping' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5a61dcd08902a7_64110769',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5a61dcd08902a7_64110769')) {
function content_5a61dcd08902a7_64110769 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '72075a61dcd07a4128_60550644';
?>
<div id="main">
					...
					<div class="col-md-3">
						<div class="block hidden-sm hidden-xs">
							<div class="block-content">
								<ul>
									<li>
				                		<a href="<?php echo siteUrl('page/about');?>
">Hakkımızda</a>
				                	</li>
				                	<li>
				                		<a href="<?php echo siteUrl('page/media-images');?>
">Medya ve Görseller</a>
				                	</li>
				                	<li>
				                		<a href="<?php echo siteUrl('page/human-resources');?>
">İnsan Kaynakları</a>
				                	</li>
				                	<li>
...
">İletişim</a>
			...
			<?php } elseif (getUrl(1) == 'media-images') {?>
				<ul class="breadcrumb">
				    <li><a href="<?php echo SITE_URL;?>
">Anasayfa</a></li>
				    <li class="active">Kurumsal</li>
						...
						<div class="block">
							...
							<div class="block-content">
								...
								<div class="col-md-9">
									...
									<p>
										<img src="<?php echo siteUrl('public/images/logo.png');?>
" width="150" alt="logo">
									</p>
								</div>
							</div>
			...
			<?php } elseif (getUrl(1) == 'human-resources') {?>
				<ul class="breadcrumb">
				    <li><a href="<?php echo SITE_URL;?>
">Anasayfa</a></li>
				    <li class="active">Kurumsal</li>
...
>
			...
			<?php } elseif (getUrl(1) == 'privacy-policy') {?>
				<ul class="breadcrumb">
				    <li><a href="<?php echo SITE_URL;?>
">Anasayfa</a></li>
					...
					<div class="col-md-3">
						<div class="block hidden-sm hidden-xs">
							<div class="block-content">
								<ul>
									<li>
				                		<a href="<?php echo siteUrl('page/safe-shopping-tips');?>
">Güvenli Alışverişin İpuçları</a>
				                	</li>
				                	<li>
				                		<a href="<?php echo siteUrl('page/terms-of-use');?>
">Kullanım Koşulları</a>
				                	</li>
				                	<li>
				                		<a href="<?php echo siteUrl('page/membership-agreement');?>
">Üyelik Sözleşmesi</a>
				                	</li>
				                	<li>
				                		<a href="<?php echo siteUrl('page/privacy-policy');?>
">Gizlilik Politikası</a>
				                	</li>
				                	<li>
				                		<a href="<?php echo siteUrl('page/help-and-processing-guide');?>
">Yardım ve İşlem Rehberi</a>
			...
			<?php } elseif (getUrl(1) == 'safe-shopping-tips') {?>
				<ul class="breadcrumb">
				    <li><a href="<?php echo SITE_URL;?>
">Anasayfa</a></li>
				    <li class="active">Gizlilik ve Kullanım</li>
...
">Yardım ve İşlem Rehberi</a>
			...
			<?php } elseif (getUrl(1) == 'advertisement') {?>
				<ul class="breadcrumb">
				    <li><a href="<?php echo SITE_URL;?>
">Anasayfa</a></li>
...
">Doping</a>
				                	...
				                	<li>
				                		<a href="<?php echo siteUrl('page/advertisement');?>
">Reklam</a>
				                	</li>
				                	<li>
				                		<a href="<?php echo siteUrl('page/mobile');?>
">Mobil</a>
				                	</li>
				                	<li>
				                		<a href="<?php echo siteUrl('page/safe-shopping-system');?>
">Güvenli Alışveriş Sistemi</a>
				                	</li>
								</ul>
							</div>
						</div>
...
>
			...
			<?php } elseif (getUrl(1) == 'membership-agreement') {?>
				<ul class="breadcrumb">
				    <li><a href="<?php echo SITE_URL;?>
">Anasayfa</a></li>
				    <li class="active">Gizlilik ve Kullanım</li>
		...
		<?php if (getUrl(1) == 'doping') {?>
			...
			<section class="dopings">
				<div class="container">
					...
					<h2 style="margin: 10px 0 30px;font-size: 15px;font-weight: 400;color: #27313c;line-height: 30px;text-align: center;">Doping, ilanınızı <a href="<?php echo SITE_URL;?>
" title="galericilerden.com">galericilerden.com</a>’da ve içerik ortaklarında ön plana çıkartarak çok daha fazla kişi tarafından<br>
...
?>
		                		<div class="col-md-3">
									...
									<h5 class="text-center"><?php echo $_smarty_tpl->tpl_vars['doping']->value['doping_name'];?>
</h5>
									<p class="text-center"><?php echo $_smarty_tpl->tpl_vars['doping']->value['doping_text'];?>
</p>
		                		</div>
		                	<?php
...
$foreach_doping_Sav = $_smarty_tpl->tpl_vars['doping'];
?>
            	<section class="doping dopings-<?php echo $_smarty_tpl->tpl_vars['doping']->value['id'];?>
">
            		<div class="container">
            			<div class="col-md-6">
	            			<?php if ($_smarty_tpl->tpl_vars['doping']->value['id'] == 1) {?>
								<img src="<?php echo siteUrl('public/images/doping/home.webp');?>
" width="100%" alt="doping home">
							<?php } elseif ($_smarty_tpl->tpl_vars['doping']->value['id'] == 2) {?>
								<img src="<?php echo siteUrl('public/images/doping/acil.webp');?>
" width="100%" alt="doping acil">
							<?php } elseif ($_smarty_tpl->tpl_vars['doping']->value['id'] == 3) {?>
								<img src="<?php echo siteUrl('public/images/doping/up.webp');?>
" width="100%" alt="doping up">
							<?php } elseif ($_smarty_tpl->tpl_vars['doping']->value['id'] == 4) {?>
								<img src="<?php echo siteUrl('public/images/doping/differently.webp');?>
" width="100%" alt="doping differently">
							<?php }?>
	            		</div>
	            		<div class="col-md-6">
	            			<div class="doping-icon">
							...
							<h5 class="text-center">Doping kullanım süresi: <?php echo $_smarty_tpl->tpl_vars['doping']->value['doping_time'];?>
 gün</h5><br>
							<h5 class="text-center">Bireysel Üyeler İçin: 
								<?php if ($_smarty_tpl->tpl_vars['doping']->value['doping_individual_price'] > 0) {?>
									<?php echo $_smarty_tpl->tpl_vars['doping']->value['doping_individual_price'];?>
 TL
								<?php } else { ?>
									Ücretsiz
								<?php }?>
							...
							<h5 class="text-center">Kurumsal Üyeler İçin: 
								<?php if ($_smarty_tpl->tpl_vars['doping']->value['doping_corporate_price'] > 0) {?>
									<?php echo $_smarty_tpl->tpl_vars['doping']->value['doping_individual_price'];?>
 TL
								<?php } else { ?>
									Ücretsiz
...
?>
        <?php } elseif (getUrl(1) == 'mobile') {?>
        	<link rel="stylesheet" href="<?php echo siteUrl('public/styles/devices.min.css');?>
">
	        	...
	        	<div class="container">
		        	<div class="col-md-7">
						<div class="col-md-6 marvel-device iphone-x">
						    ...
						    <div class="screen">
						        <img src="<?php echo siteUrl('public/images/pageMobile.png');?>
" width="100%" height="100%" alt="mobile page">
						    </div>
						</div>
		        	...
		        	<div class="col-md-5">
		        		...
		        		<div class="market">
		        			<ul>
		        				<li>
		        					<a href="#">
		        						<img src="<?php echo siteUrl('public/images/app_store.webp');?>
" width="200" alt="app store">
		        					</a>
		        				</li>
		        				<li>
		        					<a href="#">
		        						<img src="<?php echo siteUrl('public/images/google_play.webp');?>
" width="200" alt="google play">
		        					</a>
		        				</li>
		        			</ul>
		        		</div>
