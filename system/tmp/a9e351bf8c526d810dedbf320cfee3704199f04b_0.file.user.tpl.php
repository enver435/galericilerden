<?php /* Smarty version 3.1.27, created on 2018-01-18 13:35:06
         compiled from "C:\xampp\htdocs\galericilerden\app\view\user.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:123395a60947ab45078_87466214%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a9e351bf8c526d810dedbf320cfee3704199f04b' => 
    array (
      0 => 'C:\\xampp\\htdocs\\galericilerden\\app\\view\\user.tpl',
      1 => 1516278684,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '123395a60947ab45078_87466214',
  'variables' => 
  array (
    'return' => 0,
    'ads' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5a60947ac4ae78_29843083',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5a60947ac4ae78_29843083')) {
function content_5a60947ac4ae78_29843083 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '123395a60947ab45078_87466214';
?>
<div id="main">
				...
				<div class="ad-list">
					<div class="col-lg-10 col-md-10" style="padding-left: 0;width: 80%;">
						<div class="block category-step">
							<p style="display: inline-block;"><b>"<?php echo smarty_modifier_capitalize(userInfo($_GET['userId'],'name'));?>
 <?php echo smarty_modifier_capitalize(userInfo($_GET['userId'],'surname'));?>
"</b> kullanıcısına ait <strong style="color: #ff263a;"><?php echo number_format($_smarty_tpl->tpl_vars['return']->value['userAdsCount'],0,".",",");?>
						...
						<div class="ads-container">
							...
							<div class="block">
								<div class="list-desktop hidden-sm hidden-xs">
									<?php if ($_smarty_tpl->tpl_vars['return']->value['userAds']) {?>
										<table class="table">
											<thead>
												<tr>
													<th></th>
											...
											<tbody>
												<?php
$_from = $_smarty_tpl->tpl_vars['return']->value['userAds'];
...
?>
									...
									<?php } else { ?>
										<div class="block" style="margin-bottom: 0;">
											<p class="text-danger text-center" style="margin-top: 15px;"><b>Bu kullanıcıya ait sonuç bulunamadı</b></p>
										</div>
									<?php }?>
								</div>
...
&pageSize=50">50</a>
								...
								<div class="mobilePagination hidden-lg hidden-md"><?php echo $_smarty_tpl->tpl_vars['return']->value['pagination']['mobilePagination'];?>
</div>
							<?php }?>
						</div>
					</div>	
